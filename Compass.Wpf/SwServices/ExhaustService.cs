...
public class ExhaustService : BaseSwService, IExhaustService
{
    ...
    /// 排风脖颈
    /// </summary>
    public void ExhaustSpigotFs(AssemblyDoc swAssyLevel1, string suffix, double length, double middleToRight, int exhaustSpigotNumber, double exhaustSpigotLength, double exhaustSpigotWidth, double exhaustSpigotHeight, double exhaustSpigotDis, bool marvelSpigot, bool marvelRail, bool ansul, ExhaustType_e exhaustType)
    {
        //2023-06-19，发现例外情况，Pack出的FNCE0013-2变成了FNCE0013-5
        ExhaustSpigot(swAssyLevel1, suffix, length, middleToRight, exhaustSpigotNumber, exhaustSpigotLength, exhaustSpigotWidth, exhaustSpigotHeight, exhaustSpigotDis, marvelSpigot, ansul, exhaustType, "FNHE0006-1", "FNHE0007-1", "FNHE0008-1", "FNHE0009-1");
        //排风滑门导轨
        ExhaustDoorRail(swAssyLevel1, suffix, marvelRail, exhaustSpigotLength,exhaustSpigotWidth, "FNCE0013-1", "FNCE0013-5", "FNCE0018-1", "FNCE0018-5");
    }
    ...
    public void KvFr555(AssemblyDoc swAssyTop, string suffix, double length, double width, double height, SidePanel_e sidePanel, UvLightType_e uvLightType, double middleToRight,LightType_e lightType, int exhaustSpigotNumber, double exhaustSpigotLength, double exhaustSpigotWidth, double exhaustSpigotHeight, double exhaustSpigotDis, DrainType_e drainType, bool waterCollection, bool backToBack, bool marvel, bool ansul, AnsulSide_e ansulSide, AnsulDetector_e ansulDetector)
    {
        var swAssyLevel1 = swAssyTop.GetSubAssemblyDoc(suffix, "Exhaust_KV_FR_555-1", Aggregator);
        ExhaustKvFr555(swAssyLevel1, suffix, length, width, height, sidePanel, uvLightType, middleToRight,lightType, exhaustSpigotNumber, exhaustSpigotLength, exhaustSpigotWidth, exhaustSpigotHeight, exhaustSpigotDis, drainType, waterCollection, backToBack, marvel, ansul, ansulSide, ansulDetector, ExhaustType_e.KV);
    }
    ...
    public void KvFr450(AssemblyDoc swAssyTop, string suffix, double length, double width, double height, SidePanel_e sidePanel, UvLightType_e uvLightType, double middleToRight, LightType_e lightType, int exhaustSpigotNumber, double exhaustSpigotLength, double exhaustSpigotWidth, double exhaustSpigotHeight, double exhaustSpigotDis, DrainType_e drainType, bool waterCollection, bool backToBack, bool marvel, bool ansul, AnsulSide_e ansulSide, AnsulDetector_e ansulDetector)
    {
        var swAssyLevel1 = swAssyTop.GetSubAssemblyDoc(suffix, "Exhaust_KV_FR_450-1", Aggregator);
        ExhaustKvFr450(swAssyLevel1, suffix, length, width, height, sidePanel, uvLightType, middleToRight, lightType, exhaustSpigotNumber, exhaustSpigotLength, exhaustSpigotWidth, exhaustSpigotHeight, exhaustSpigotDis, drainType, waterCollection, backToBack, marvel, ansul, ansulSide, ansulDetector, ExhaustType_e.KV);
    }
    ...
    public void UvFr555(AssemblyDoc swAssyTop, string suffix, double length,double width, double height, SidePanel_e sidePanel, UvLightType_e uvLightType, double middleToRight,LightType_e lightType, int exhaustSpigotNumber, double exhaustSpigotLength, double exhaustSpigotWidth, double exhaustSpigotHeight, double exhaustSpigotDis, DrainType_e drainType, bool waterCollection, bool backToBack, bool marvel, bool ansul, AnsulSide_e ansulSide, AnsulDetector_e ansulDetector)
    {
        var swAssyLevel1 = swAssyTop.GetSubAssemblyDoc(suffix, "Exhaust_UV_FR_555-1", Aggregator);
        ExhaustKvFr555(swAssyLevel1, suffix, length,width, height, sidePanel, uvLightType, middleToRight,lightType, exhaustSpigotNumber, exhaustSpigotLength, exhaustSpigotWidth, exhaustSpigotHeight, exhaustSpigotDis, drainType, waterCollection, backToBack, marvel, ansul, ansulSide, ansulDetector, ExhaustType_e.UV);
    ...
    public void UvFr450(AssemblyDoc swAssyTop, string suffix, double length, double width, double height, SidePanel_e sidePanel, UvLightType_e uvLightType, double middleToRight, LightType_e lightType, int exhaustSpigotNumber, double exhaustSpigotLength, double exhaustSpigotWidth, double exhaustSpigotHeight, double exhaustSpigotDis, DrainType_e drainType, bool waterCollection, bool backToBack, bool marvel, bool ansul, AnsulSide_e ansulSide, AnsulDetector_e ansulDetector)
    {
        var swAssyLevel1 = swAssyTop.GetSubAssemblyDoc(suffix, "Exhaust_UV_FR_450-1", Aggregator);
        ExhaustKvFr450(swAssyLevel1, suffix, length, width, height, sidePanel, uvLightType, middleToRight, lightType, exhaustSpigotNumber, exhaustSpigotLength, exhaustSpigotWidth, exhaustSpigotHeight, exhaustSpigotDis, drainType, waterCollection, backToBack, marvel, ansul, ansulSide, ansulDetector, ExhaustType_e.UV);
        ExhaustUvFr450(swAssyLevel1, suffix, length, uvLightType, middleToRight, ansul, ansulSide, ansulDetector);
    }
    ...
    private void ExhaustSpigotHw(AssemblyDoc swAssyLevel1, string suffix, double length, double middleToRight, int exhaustSpigotNumber, double exhaustSpigotLength, double exhaustSpigotWidth, double exhaustSpigotHeight, double exhaustSpigotDis, bool marvel, bool ansul, ExhaustType_e exhaustType)
    {
        ...
        //华为烟罩全部需要下料，因此不要考虑marvel的情况
        ExhaustDoorRail(swAssyLevel1, suffix, false, exhaustSpigotLength, exhaustSpigotWidth, doorPart1, doorPart2, railPart1, railPart2);
    ...
    private void ExhaustDoorRail(AssemblyDoc swAssyLevel1, string suffix, bool marvel, double exhaustSpigotLength,double exhaustSpigotWidth, string doorPart1, string doorPart2, string railPart1, string railPart2)
    {
        //Door
        if (marvel || exhaustSpigotWidth.Equals(300d))
        {
    ...
    private void ExhaustKv555(AssemblyDoc swAssyLevel1, string suffix, double length, double height, SidePanel_e sidePanel, UvLightType_e uvLightType, double middleToRight, int exhaustSpigotNumber, double exhaustSpigotLength, double exhaustSpigotWidth, double exhaustSpigotHeight, double exhaustSpigotDis, DrainType_e drainType, bool waterCollection, bool backToBack, bool marvel, bool ansul, AnsulSide_e ansulSide, AnsulDetector_e ansulDetector, ExhaustType_e exhaustType)
    {
        ...
        ExhaustSpigotFs(swAssyLevel2, suffix, length, middleToRight, exhaustSpigotNumber, exhaustSpigotLength, exhaustSpigotWidth, exhaustSpigotHeight, exhaustSpigotDis, marvel,marvel, ansul, exhaustType);
    ...
    #region KvFr555
    private void ExhaustKvFr555(AssemblyDoc swAssyLevel1, string suffix, double length, double width, double height, SidePanel_e sidePanel, UvLightType_e uvLightType, double middleToRight,LightType_e lightType, int exhaustSpigotNumber, double exhaustSpigotLength, double exhaustSpigotWidth, double exhaustSpigotHeight, double exhaustSpigotDis, DrainType_e drainType, bool waterCollection, bool backToBack, bool marvel, bool ansul, AnsulSide_e ansulSide, AnsulDetector_e ansulDetector, ExhaustType_e exhaustType)
    {
        //排风背面板
        ...
        //排风腔前面板
        FNHE0197(swAssyLevel1, suffix, "FNHE0197-1", length,width, uvLightType, middleToRight,lightType);
    ...
    private void FNHE0197(AssemblyDoc swAssyLevel1, string suffix, string partName, double length, double width, UvLightType_e uvLightType,
        double middleToRight,LightType_e lightType)
    {
        ...
        //2023.10.11,零件的这个边一加长就会发生错误，改成移动面
        if ((midWidth + 2.5d) > 20d)
        {
            swModelLevel2.ChangeDim("Width@MoveFace", midWidth + 2.5d-20d);
        }
    ...
    private void ExhaustUv555(AssemblyDoc swAssyLevel1, string suffix, double length, UvLightType_e uvLightType, double middleToRight, bool ansul, AnsulSide_e ansulSide, AnsulDetector_e ansulDetector)
    {
        ...
        swAssyLevel1.ChangePartLength(suffix, "FNHE0015-1", "Length@SketchBase",length-5d,Aggregator);
    ...
    private void FNHE0014(AssemblyDoc swAssyLevel1, string suffix, string partName, double length, bool ansul, AnsulDetector_e ansulDetector)
    {
        var swCompLevel2 = swAssyLevel1.UnSuppress(out ModelDoc2 swModelLevel2, suffix, partName, Aggregator);
    ...
    {
        FNHE0200(swAssyLevel1, suffix, "FNHE0200-1", length, ansul, ansulDetector);
        swAssyLevel1.ChangePartLength(suffix, "FNHE0199-1", "Length@SketchBase", length, Aggregator);

        FNHE0198(swAssyLevel1, suffix, "FNHE0198-1", length, uvLightType, middleToRight);
    ...
    private void FNHE0198(AssemblyDoc swAssyLevel1, string suffix, string partName, double length, UvLightType_e uvLightType, double middleToRight)
    {
        var swCompLevel2 = swAssyLevel1.UnSuppress(out ModelDoc2 swModelLevel2, suffix, partName, Aggregator);
        swModelLevel2.ChangeDim("Length@SketchBase", length);
        #region UVHood
    ...
    #region KvFr450
    private void ExhaustKvFr450(AssemblyDoc swAssyLevel1, string suffix, double length, double width, double height, SidePanel_e sidePanel, UvLightType_e uvLightType, double middleToRight, LightType_e lightType, int exhaustSpigotNumber, double exhaustSpigotLength, double exhaustSpigotWidth, double exhaustSpigotHeight, double exhaustSpigotDis, DrainType_e drainType, bool waterCollection, bool backToBack, bool marvel, bool ansul, AnsulSide_e ansulSide, AnsulDetector_e ansulDetector, ExhaustType_e exhaustType)
    {
        //排风背面板
        FNHE0195(swAssyLevel1, suffix, "FNHE0220-1", length, sidePanel, drainType, waterCollection, backToBack);

        //排风顶板
        FNHE0196(swAssyLevel1, suffix, "FNHE0196-1", length, sidePanel, uvLightType, middleToRight, exhaustSpigotNumber, exhaustSpigotLength, exhaustSpigotWidth, exhaustSpigotDis, marvel, ansul, ansulSide, ansulDetector);

        //排风腔前面板
        FNHE0197(swAssyLevel1, suffix, "FNHE0221-1", length, width, uvLightType, middleToRight, lightType);
    ...
    #region UvFr450
    private void ExhaustUvFr450(AssemblyDoc swAssyLevel1, string suffix, double length, UvLightType_e uvLightType, double middleToRight, bool ansul, AnsulSide_e ansulSide, AnsulDetector_e ansulDetector)
    {
        //MESH轨道下
        FNHE0224(swAssyLevel1, suffix, "FNHE0224-1", length);
        //MESH轨道上1
        swAssyLevel1.ChangePartLength(suffix,"FNHE0226-1", "Length@SketchBase", length,Aggregator);
        //MESH轨道上2
        FNHE0198(swAssyLevel1, suffix, "FNHE0225-1", length, uvLightType, middleToRight);
    ...
    private void ExhaustUvHw650(AssemblyDoc swAssyLevel1, string suffix, double length, double height, SidePanel_e sidePanel, UvLightType_e uvLightType, double middleToRight, int exhaustSpigotNumber, double exhaustSpigotLength, double exhaustSpigotWidth, double exhaustSpigotHeight, double exhaustSpigotDis, DrainType_e drainType, bool waterCollection, bool backToBack, bool marvel, bool ansul, AnsulSide_e ansulSide, AnsulDetector_e ansulDetector, ExhaustType_e exhaustType)
    {
        ...
        swAssyLevel1.ChangePartLength(suffix, "FNHE0189-1", "Length@SketchBase", length-7d, Aggregator);
    ...
    private void ExhaustSpigotCmod(AssemblyDoc swAssyLevel1, string suffix, double length, double middleToRight, int exhaustSpigotNumber, double exhaustSpigotLength, double exhaustSpigotWidth, double exhaustSpigotHeight, double exhaustSpigotDis, bool marvel, bool ansul, ExhaustType_e exhaustType)
    {
        ...
        //排风滑门和导轨
        ExhaustDoorRail(swAssyLevel1, suffix, marvel, exhaustSpigotLength,exhaustSpigotWidth, "FNCE0013-1", "FNCE0013-5", "FNCE0018-1", "FNCE0018-5");
    }
