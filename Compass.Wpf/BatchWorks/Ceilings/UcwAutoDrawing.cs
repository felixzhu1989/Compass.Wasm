...
public interface IUcwAutoDrawing : IAutoDrawing
{

}

public class UcwAutoDrawing : BaseAutoDrawing, IUcwAutoDrawing
{
    #region ctor
    private readonly IUcwDataService _service;

    public UcwAutoDrawing(IContainerProvider provider) : base(provider)
    {
