...
public interface ILkAutoDrawing : IAutoDrawing
{

}

public class LkAutoDrawing:BaseAutoDrawing,ILkAutoDrawing
{
    #region ctor
    private readonly ILkDataService _service;
    public LkAutoDrawing(IContainerProvider provider) : base(provider)
    {
    ...
    public async Task AutoDrawingAsync(ModuleDto moduleDto)
    {
        try
        {
            ...
            {
                case "LK_SS_270":
                    CeilingService.LkSs270(swModelTop, swAssyTop, suffix, moduleDto.Name, data);
                    break;
                case "LK_ST_270":
                    CeilingService.LkSt270(swModelTop, swAssyTop, suffix, moduleDto.Name, data);
                    break;
                case "LK_AL_258":
                    CeilingService.LkAl258(swModelTop, swAssyTop, suffix, moduleDto.Name, data);
                    break;
