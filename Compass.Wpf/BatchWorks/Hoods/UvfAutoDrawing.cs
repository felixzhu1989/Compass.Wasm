...
public class UvfAutoDrawing : BaseAutoDrawing, IUvfAutoDrawing
{
    ...
    private void Uvf450400(UvfData data, ModelDoc2 swModelTop, AssemblyDoc swAssyTop, string suffix)
    {
        ...
        SupplyService.F400(swAssyTop, suffix, netLength, netWidth, data.Height, ExhaustType_e.KV, data.SidePanel, data.UvLightType, data.Bluetooth, data.Marvel, data.LedLogo, data.WaterCollection, data.SupplySpigotNumber, data.SupplySpigotDis);
        #endregion
