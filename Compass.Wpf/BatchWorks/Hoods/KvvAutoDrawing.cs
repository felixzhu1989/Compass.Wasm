...
public class KvvAutoDrawing : BaseAutoDrawing, IKvvAutoDrawing
{
    ...
    private void Kvv555(KvvData data, ModelDoc2 swModelTop, AssemblyDoc swAssyTop, string suffix)
    {
        ...
        //冷凝板参数
        var panelAngle = default(double);
        var panelHeight = default(double);
        switch ((int)(data.Width / 100d))//取百位以上整数
        {
            case 6:
                panelAngle = (160.2d * Math.PI) / 180d;
                panelHeight = 357.1d;
                break;
            case 7:
                panelAngle = (160.2d * Math.PI) / 180d;
                ...
                break;
            case 8:
                panelAngle = (146.7d * Math.PI) / 180d;
                panelHeight = 402.3d;
                break;
            case 9:
                panelAngle = (146.7d * Math.PI) / 180d;
            ...
            case 16:
                panelAngle = (118.4d * Math.PI) / 180d;
                panelHeight = 706.6d;
                break;
            case 17:
                panelAngle = (118.4d * Math.PI) / 180d;
            ...
            default://默认是标准模版中的值，放置模型报错
                panelAngle = (126d * Math.PI) / 180d;//126
                panelHeight = 574d;//574
                break;
        }
