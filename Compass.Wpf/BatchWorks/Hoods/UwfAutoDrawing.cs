...
public class UwfAutoDrawing : BaseAutoDrawing, IUwfAutoDrawing
{
    ...
    private void Uwf555(UwfData data, ModelDoc2 swModelTop, AssemblyDoc swAssyTop, string suffix)
    {
    ...
    private void UwfHw650(UwfData data, ModelDoc2 swModelTop, AssemblyDoc swAssyTop, string suffix)
    {
        #region 计算中间值与顶层操作
        //计算烟罩净长度，计算烟罩净深度
        var netLength = data.SidePanel==SidePanel_e.左||data.SidePanel==SidePanel_e.右 ? data.Length-50d : data.SidePanel==SidePanel_e.双 ? data.Length-100 : data.Length;
