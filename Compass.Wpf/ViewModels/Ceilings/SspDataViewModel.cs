...
public class SspDataViewModel : NavigationViewModel
{
    #region ctor-SSP参数页面

    private readonly ISspDataService _service;
    public SspDataViewModel(IContainerProvider provider):base(provider)
    {
    ...
    private SspData dataDto = null!;
    public SspData DataDto
    {
        get => dataDto;
    ...
    private string[] panelTypes = null!;
    public string[] PanelTypes
    {
        get => panelTypes;
        set { panelTypes = value; RaisePropertyChanged(); }
    }
    #endregion
    ...
    private void GetEnumNames()
    {
        ...
        PanelTypes = Enum.GetNames(typeof(PanelType_e));
    }
