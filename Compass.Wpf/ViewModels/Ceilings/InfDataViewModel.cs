...
public class InfDataViewModel : NavigationViewModel
{
    #region ctor-Inf参数页面

    private readonly IInfDataService _service;
    public InfDataViewModel(IContainerProvider provider) : base(provider)
    {
    ...
    private InfData dataDto = null!;
    public InfData DataDto
    {
        get => dataDto;
