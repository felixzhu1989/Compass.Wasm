...
public class LpDataViewModel : NavigationViewModel
{
    #region ctor-SSP参数页面

    private readonly ILpDataService _service;
    public LpDataViewModel(IContainerProvider provider) : base(provider)
    {
    ...
    private LpData dataDto = null!;
    public LpData DataDto
    {
        get => dataDto;
