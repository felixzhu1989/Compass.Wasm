...
public class UviDataViewModel : NavigationViewModel
{
    #region ctor-Uvi参数页面
    private readonly IUviDataService _service;
    public UviDataViewModel(IContainerProvider provider) : base(provider)
    {
    ...
    private UviData dataDto = null!;
    public UviData DataDto
    {
        get => dataDto;
