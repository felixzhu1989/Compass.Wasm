...
public class UwfDataViewModel : NavigationViewModel
{
    #region ctor-Uwf参数页面
    private readonly IUwfDataService _service;
    public UwfDataViewModel(IContainerProvider provider) : base(provider)
    {
    ...
    private UwfData dataDto = null!;
    public UwfData DataDto
    {
        get => dataDto;
