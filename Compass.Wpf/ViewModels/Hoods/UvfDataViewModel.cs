...
public class UvfDataViewModel : NavigationViewModel
{
    #region ctor-Uvf参数页面
    private readonly IUvfDataService _service;
    public UvfDataViewModel(IContainerProvider provider) : base(provider)
    {
    ...
    private UvfData dataDto = null!;
    public UvfData DataDto
    {
        get => dataDto;
