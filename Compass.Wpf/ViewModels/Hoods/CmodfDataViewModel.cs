...
public class CmodfDataViewModel : NavigationViewModel
{
    #region ctor-Kwi参数页面
    private readonly ICmodfDataService _service;
    public CmodfDataViewModel(IContainerProvider provider) : base(provider)
    {
    ...
    private CmodfData dataDto = null!;
    public CmodfData DataDto
    {
        get => dataDto;
