...
public class KwfDataViewModel : NavigationViewModel
{
    #region ctor-Kwi参数页面
    private readonly IKwfDataService _service;
    public KwfDataViewModel(IContainerProvider provider) : base(provider)
    {
    ...
    private KwfData dataDto = null!;
    public KwfData DataDto
    {
        get => dataDto;
