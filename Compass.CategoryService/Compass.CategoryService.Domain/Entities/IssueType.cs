...
public record IssueType : AggregateRootEntity, IAggregateRoot, IHasCreationTime, ISoftDelete
{
    public string Name { get;private set; }
    public Stakeholder Stakeholder { get; private set; }

    private IssueType() { }
    public IssueType(Guid id, string name, Stakeholder stakeholder)
    {
        Id=id;
        Name=name;
        Stakeholder=stakeholder;
    }
    public IssueType ChangeName(string name)
    {
        Name=name;
        return this;
    }
    public IssueType ChangeStakeholder(Stakeholder stakeholder)
    {
        Stakeholder=stakeholder;
        return this;
    }
