...
public class ModuleService : IModuleService
{
    ...
    public async Task<ApiResponse<ModuleDto>> AddAsync(ModuleDto dto)
    {
        try
        {
            var model = new Compass.ProjectService.Domain.Entities.Module(Guid.NewGuid(), dto.DrawingId, dto.ModelTypeId.Value, dto.Name.ToUpper(), dto.ModelName, dto.SpecialNotes, dto.Length, dto.Width, dto.Height, dto.SidePanel,dto.Pallet);
