...
public interface IIdRepository
{
    ...
    Task<IEnumerable<User>> FindUsersByRoles(string roleNames);//获取多个角色的人员，角色以,分隔
    /// <summary>
    /// 生成重置密码的令牌
    /// </summary>
    ...
    /// </summary>
    /// <returns>返回值(元组)第三个是生成的密码</returns>
    public Task<(IdentityResult, User?, string? password)> AddUserAsync(string userName, string email, string roleName);
